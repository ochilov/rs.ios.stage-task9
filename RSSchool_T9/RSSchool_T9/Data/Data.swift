...
struct FillingData {
    static let data: [ContentType] = [
		...
		.story(Story(coverImage: .init("story-5"), title: .from("s5-title"), text: .from("s5-text"), paths: [.story5path1, .story5path2, .story5path3, .story5path4])),
		.story(Story(coverImage: .init("story-6"), title: .from("s6-title"), text: .from("s6-text"), paths: [.story6path1, .story6path2, .story6path1, .story6path2])),
		.gallery(Gallery(coverImage: .init("flight-0"), title: "Flight path", images: .init(base: "flight", count: 7))),
		.gallery(Gallery(coverImage: .init("masyana-0"), title: "Masyanya", images: .init(base: "masyana", count: 5))),
    ]
}
